...
<head>
    ...
    <link href="./Style/DFI.css" rel="stylesheet">
    <?php
    $array = ['','_2','_3'];
    $num = $array[array_rand($array)];
    $file  = "../img/posgrado/DIFI$num.jpg";
    ?>
    <style>
        #banner>.frame{
...
<div id="banner">
    <div class="frame"></div>
    <div class="lName"><label>Doctorado en Ingenieria Fisica Industrial</label></div>
    <div id="goBottom"></div>
</div>
<div class="tabContainer">
    ...
    <div name="Objetivos">
        <div class="textTab">
            <label>
            <b>OBJETIVOS DEL PROGRAMA</b><br /><br />
    ...
    <div name="Requisitos">
        <div class="textTab">
            ...
            <ul>
                ...
                <li>Cumplir requisitos administrativos impuestos por el Reglamento General de Estudios de Posgrado de la UANL y en el reglamento interno de la FCFM.</li>
            </ul>
    ...
    <div name="Estudiantes">
        <div class="textTab">
            <label>
            <b>Estudiantes</b>
            <img style="width:50%;height: 40%;" src="./rsc/estudiantesDFI.jpg" />
            </label>
        </div>
    </div>
    <div name="Profesores">
    ...
    <div name="Estadísticas del programa">
        <div class="textTab">
            ...
            <img src="./rsc/estadisticasDFI.jpg" />
            </label>
        </div>
    </div>
